...
const dictionary: Dictionary = {
  ...
  compare: {
    indexTitle: "对比项目",
    indexDescription: "选择两个开源项目，并排对比它们的许可证、分类、语言和目录评级。",
    firstProjectLabel: "第一个项目",
    secondProjectLabel: "第二个项目",
    projectPlaceholder: "按名称搜索…",
    selectPrompt: "选择两个要对比的项目。",
    evidenceLabel: "证据",
    startCompareLabel: "与其他项目对比",
    allCategoriesOption: "所有分类",
    categoryFilterLabel: "按分类筛选",
    changeSelectionLabel: "更改",
    noMatchesLabel: "没有匹配的项目。",
  },
  projectDetail: {
    overviewHeading: "概述",
    whyHeading: "为什么收录此项目",
