...
const dictionary: Dictionary = {
  ...
  compare: {
    indexTitle: "プロジェクトを比較",
    indexDescription: "オープンソースプロジェクトを2つ選んで、ライセンス・カテゴリ・言語・カタログ指標を並べて比較できます。",
    firstProjectLabel: "1つ目のプロジェクト",
    secondProjectLabel: "2つ目のプロジェクト",
    projectPlaceholder: "名前で検索…",
    selectPrompt: "比較する2つのプロジェクトを選んでください。",
    evidenceLabel: "根拠",
    startCompareLabel: "他のプロジェクトと比較する",
    allCategoriesOption: "すべてのカテゴリ",
    categoryFilterLabel: "カテゴリで絞り込む",
    changeSelectionLabel: "変更",
    noMatchesLabel: "該当するプロジェクトがありません。",
  },
  projectDetail: {
    overviewHeading: "概要",
