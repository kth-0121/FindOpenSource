...
const dictionary: Dictionary = {
  ...
  compare: {
    indexTitle: "프로젝트 비교",
    indexDescription: "오픈소스 프로젝트 두 개를 골라 라이선스, 카테고리, 언어, 카탈로그 지표를 나란히 비교해보세요.",
    firstProjectLabel: "첫 번째 프로젝트",
    secondProjectLabel: "두 번째 프로젝트",
    projectPlaceholder: "이름으로 검색…",
    selectPrompt: "비교할 프로젝트 두 개를 선택하세요.",
    evidenceLabel: "근거",
    startCompareLabel: "다른 프로젝트와 비교하기",
    allCategoriesOption: "전체 카테고리",
    categoryFilterLabel: "카테고리로 필터링",
    changeSelectionLabel: "변경",
    noMatchesLabel: "일치하는 프로젝트가 없습니다.",
  },
  projectDetail: {
    overviewHeading: "개요",
