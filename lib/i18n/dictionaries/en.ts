...
const dictionary: Dictionary = {
  ...
  compare: {
    indexTitle: "Compare projects",
    indexDescription: "Pick any two open source projects to see their license, categories, languages, and catalog signals side by side.",
    firstProjectLabel: "First project",
    secondProjectLabel: "Second project",
    projectPlaceholder: "Search by name…",
    selectPrompt: "Choose two projects to compare.",
    evidenceLabel: "Evidence",
    startCompareLabel: "Compare with another project",
    allCategoriesOption: "All categories",
    categoryFilterLabel: "Filter by category",
    changeSelectionLabel: "Change",
    noMatchesLabel: "No projects match.",
  },
  projectDetail: {
