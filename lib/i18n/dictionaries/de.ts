...
const dictionary: Dictionary = {
  ...
  categoryDetail: {
    ...
    filterAgentTools: "Agenten-Tools",
  },
  projectsPage: {
    title: "Alle Projekte",
  ...
  compare: {
    indexTitle: "Projekte vergleichen",
    indexDescription: "Wähle zwei Open-Source-Projekte aus, um Lizenz, Kategorien, Sprachen und Katalog-Signale direkt zu vergleichen.",
    firstProjectLabel: "Erstes Projekt",
    secondProjectLabel: "Zweites Projekt",
    projectPlaceholder: "Nach Namen suchen…",
    selectPrompt: "Wähle zwei Projekte zum Vergleichen aus.",
    evidenceLabel: "Belege",
    startCompareLabel: "Mit einem anderen Projekt vergleichen",
  ...
  projectDetail: {
    ...
    whyHeading: "Warum es in diesem Katalog steht",
    descriptionLabel: "Beschreibung",
    catalogRatingLabel: "Katalog-Bewertung",
    githubButton: "GitHub",
  ...
  productionReadiness: {
    foundational: "Grundlegend etabliert",
    mature: "Ausgereift",
    emerging: "Aufstrebend",
    experimental: "Experimentell",
  },
  governance: {
    foundation: "Stiftungsgeführt",
    "vendor-backed": "Herstellergestützt",
    community: "Community-getrieben",
    unknown: "Governance nicht bewertet",
  },
  about: {
